      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 items-end">
        <div className="lg:col-span-1 sm:col-span-2 space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            Leave blank to analyze top {searchQuery.trim() === '' ? '5' : ''} coins by market cap. Stablecoins are excluded.
          </p>
        </div>
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          >
            <SelectTrigger id="timeFrameFilter" className="bg-background text-xs sm:text-sm h-9 sm:h-10">
              <Clock className="mr-1.5 h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground" />
        ...
        <div className="space-y-1 sm:space-y-2">
          <Label htmlFor="confidenceFilter" className="text-xs sm:text-sm">Filter Confidence</Label>
          <Select
